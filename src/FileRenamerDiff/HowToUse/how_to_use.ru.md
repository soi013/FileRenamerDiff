...
4. Выполнить переименование: Выполните <kbd>Сохранить переименование</kbd>, чтобы фактически переименовать файл.
...
Вы можете указать условия поиска файлов в разделе <kbd>Настройки</kbd> > <kbd>Выполнить поиск файлов</kbd>.
...
| ------------------ | ------------------------------------------------------------ | --------- | ------------------------- | -------- |
| `[`ch_group`]`     | Любая буква в *ch_group*.                                    | [ae]      | gr**a**y, L**A**N**E**    | gry,LN   |
...
| ------ | ------------------------------------------------------------ | --------------- | --------------- | -------------- | ------------------ |
| `$0`   | Включить весь совпадающий ряд символов в замененный ряд символов | ABC             | \[\$0\]         | x**ABC**x_AxBC | x**\[ABC\]**x_AxBC |
...
<kbd>Сохранить переименование</kbd> сохраняет действительное имя файла. Невозможно выполнить сохранение, если в списке файлов есть дубликаты.
